  ...
  try {
    ...
    return res.json({
      ...
      data: {
        ...
        popup_config: {
          jz_popup1_enabled: 设置对象.jz_popup1_enabled || '0',
          jz_popup1_title: 设置对象.jz_popup1_title || '温馨提醒',
          jz_popup1_content: 设置对象.jz_popup1_content || '您所在的城市，阿姨接单繁忙，会有一定概率无阿姨接单的情况。',
          jz_popup1_icon: 设置对象.jz_popup1_icon || '⚠️',
          jz_popup1_title_color: 设置对象.jz_popup1_title_color || '#e54635',
          jz_popup1_content_color: 设置对象.jz_popup1_content_color || '#333333',
          jz_popup1_btn_text: 设置对象.jz_popup1_btn_text || '我知道了',
          jz_popup1_btn_color: 设置对象.jz_popup1_btn_color || '#e54635',
          jz_popup1_btn_size: 设置对象.jz_popup1_btn_size || 'large',
          jz_popup1_auto_close: 设置对象.jz_popup1_auto_close || '0',
          jz_popup1_bg_color: 设置对象.jz_popup1_bg_color || '#ffffff',
          jz_popup2_enabled: 设置对象.jz_popup2_enabled || '0',
          jz_popup2_title: 设置对象.jz_popup2_title || '退改签须知',
          jz_popup2_content: 设置对象.jz_popup2_content || '一旦预约成功，退改签将收取50元的手续费，请确认后再提交。',
          jz_popup2_icon: 设置对象.jz_popup2_icon || '📋',
          jz_popup2_title_color: 设置对象.jz_popup2_title_color || '#e54635',
          jz_popup2_content_color: 设置对象.jz_popup2_content_color || '#333333',
          jz_popup2_btn_text: 设置对象.jz_popup2_btn_text || '我已知晓',
          jz_popup2_btn_color: 设置对象.jz_popup2_btn_color || '#e54635',
          jz_popup2_btn_size: 设置对象.jz_popup2_btn_size || 'large',
          jz_popup2_auto_close: 设置对象.jz_popup2_auto_close || '0',
          jz_popup2_bg_color: 设置对象.jz_popup2_bg_color || '#ffffff',
        },
      },
    });
  } catch (错误) {
